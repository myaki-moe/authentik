---
title: Using the authentik Customer Portal
---
...
To verify that the license was successfully installed, confirm that the expiry date on the **Enterprise --> Licenses** page displays a date one year later.
